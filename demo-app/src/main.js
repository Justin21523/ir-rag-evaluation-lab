...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/ir-rag-evaluation-lab",
  "readmeUrl": "https://github.com/Justin21523/ir-rag-evaluation-lab#readme",
  ...
  "features": [
    "Detected technical signals: Python, FastAPI, DuckDB, React, Vite, TypeScript, BM25, RAG, llama",
    "cpp, ECharts, Recharts, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
    "I built a FastAPI + DuckDB backend for dataset registry, BM25/dense/hybrid/rerank retrievers, experiment persistence, retrieval metrics, bad case root-cause workflow, RAG claim-to-evidence evaluation, llama",
    "cpp local judge history, and text-mining analytics",
    "The React + TypeScript + Vite frontend provides an auto-starting guided assistant, Pipeline Journey, interactive heatmaps, scatter plots, networks, Sankey-style flows, and chart dashboards, all verified with Playwright screenshots and a walkthrough recording"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, FastAPI, DuckDB, React, Vite, TypeScript, BM25, RAG, llama",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "cpp, ECharts, Recharts, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "I built a FastAPI + DuckDB backend for dataset registry, BM25/dense/hybrid/rerank retrievers, experiment persistence, retrieval metrics, bad case root-cause workflow, RAG claim-to-evidence evaluation, llama",
      "status": "Queued",
      "owner": "Automation"
    },
    {
      "id": "flow-04",
      "name": "cpp local judge history, and text-mining analytics",
      "status": "Ready",
      "owner": "Product"
    },
    {
      "id": "flow-05",
      "name": "The React + TypeScript + Vite frontend provides an auto-starting guided assistant, Pipeline Journey, interactive heatmaps, scatter plots, networks, Sankey-style flows, and chart dashboards, all verified with Playwright screenshots and a walkthrough recording",
      "status": "Review",
      "owner": "Quality"
    }
  ]
